...
- [~] P2. Section 8 rebuilt 2026-09-01; corrected 2026-09-09 (Astra B1-B5: head hypothesis unmet, anisotropy wording, optimizer-family control, bound proxy withdrawn, 3.7x full contrast); 8.4/8.5 rewritten 2026-09-10 around the matched lane (no resolvable freezing effect); 8.3 "What carries the width trend" paragraph added 2026-09-10 from exp1_8d (3 seeds; Astra's replacement wording verbatim + measured BN-gain mechanism + c^-2 scale law; "sole source" never used). Remaining: author review; exp1_8d witness table and the exp1_2v5 residual-export paragraph (Sec 7) go in with the 9-page restructure; §8.4 causal wording must be replaced by Astra's reply_02 Q6 paragraph (already applied in the ICLR draft sections_iclr/08_matched.tex; the 48-page draft still carries "property of the training protocol, not of the architecture" and "sufficient to manufacture"). Section 8 rebuild, artifacts only, companion cited correctly
