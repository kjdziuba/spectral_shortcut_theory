...
\emph{un-orthogonalized} full contrast requires a separate computation
that is pending; it will be reported in the appendix. Meanwhile the
spatial
...
restricted curvature along the $v_1$-orthogonalized contrast.}
