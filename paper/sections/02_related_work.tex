...
of the Fisher Information Matrix, showing it scales linearly with the
layer width. Theorem~\ref{thm:hessian} works blockwise on the joint
Gauss--Newton matrix of a compositional model: a width-linear lower
bound on the spatial block's top eigenvalue is combined with a
width-independent operator-norm cap on the spectral block, yielding a
width-scaling law for the module curvature disparity
