...
the flow unchanged (bound uniform
...
sharpest form of the claim: \emph{substantial spectral learning
requires slow fitting}. A trajectory on which $\thetap$ moves far
must have small $\mu$---the loss must stay unfit for a long
time---which is precisely what freezing-based pipelines engineer and
what fast-fitting joint training precludes. The hypothesis is also
