...
The population picture behind Assumption~\ref{ass:subg}
(Remark~\ref{rem:subg_population}) already grants this cure:
well-conditioned (e.g.\ normalized) inputs. The disparity persists regardless, because its growth is
