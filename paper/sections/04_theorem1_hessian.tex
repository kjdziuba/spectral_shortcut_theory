...
Assumption~\ref{ass:subg} already grants this cure: we assume the
population second moment $\Sigma$ has bounded condition number,
i.e.\ well-conditioned (e.g.\ normalized) inputs. The disparity persists regardless, because its growth is
