...
$4.5$--$6.3$ of the realised displacement here ($3.8$ with the true residual
amplitude), and every displayed quantity agrees with the closed form to
...
\begin{figure}[t]
\centering
\IfFileExists{figures/fig1_serial.pdf}{\includegraphics[width=0.92\linewidth]{figures/fig1_serial.pdf}}{\fbox{\rule{0pt}{2.3in}\rule{0.97\linewidth}{0pt}}}
