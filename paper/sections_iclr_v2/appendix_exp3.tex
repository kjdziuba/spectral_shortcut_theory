...
of absorbance, first and second derivative ($3\times314$ channels). Up to
...
\subsection{Results}
%% [E3] tables at L*: per regime, arm, width, kappa, seed: probe gain,
%% acc iid / reversed / context-random / spectral-only (val and test).
