...
\caption{Experiment 3, unready (whitened) regime, at $L^\ast=0.30$: mean$\pm$sd over seeds (number of seeds). Probe gain = discriminant accuracy on the encoder output of validation centres minus its initial value; accuracies on validation (val) and test (test) patients under the paired conditions.}\label{tab:exp3_unready}
