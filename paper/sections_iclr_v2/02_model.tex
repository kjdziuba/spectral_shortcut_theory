...
The contextual cue lies in the eight nearest neighbours along
large-amplitude directions that a random encoder passes; the spectral cue
lies in the pixel's own spectrum along a small-amplitude direction that,
in the low-accessibility settings, requires encoder alignment. Evaluation
under iid, reversed and context-random contexts measures reliance and
failure.}
\label{fig:model}
\end{figure}
