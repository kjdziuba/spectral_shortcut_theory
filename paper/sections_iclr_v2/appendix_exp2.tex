...
seeds agree with the registered ones on every direction (the whole-head rate raises the probe
gain from $0.008$ and $0.005$ to $0.225$ and $0.221$, and retraining recovers $0.81$ and $0.77$
from their $\kappa=1/256$ encoders against $0.60$ and $0.57$ from $\kappa=1$).
