...
about $0.126$ nats (spectral alone $0.127$), so training losses below about
$0.13$ cannot be reached by either cue alone and the threshold $0.15$ sits
just above the contextual optimum.
...
\subsection{Results}
%% [E2] tables: per-seed values at L* for every arm; secondary thresholds
%% 0.15 and 0.10; kappa sweep; runs that never reached L*; trajectories.
\emph{[Results tables pending: the grid is running.]}
