...
for widths $8$--$512$ and for $\kappa=1$, $1/16$, $1/256$ alike, all
fitting within $70$--$230$ steps; the uninformative-context comparator
...
while reversal accuracy stays at $0.06$--$0.08$ and the comparator again
reaches a gain of $0.35$ and reversal $0.92$
(Table~\ref{tab:exp3_unready10}). The net update remains in the cue span
...
the cue's amplitude, which are not interchangeable here. The construction
matters: with the natural $3\times3$ neighbourhoods of the same cores,
which never straddle two classes, the encoder learns the class signal
equally with and without informative context and the model uses the full
spectrum, on tissue and on a public hyperspectral scene
(Appendices~\ref{app:exp4} and~\ref{app:pavia}).
